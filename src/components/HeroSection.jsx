    ...
    <>
      ...
      <section className="hero hero-desktop">
        ...
        <div className="hero-right">
          <p className="hero-tagline-desktop">Un hogar para<br />cada ronroneo</p>
        ...
        {/* RRSS abajo izquierda */}
        <div className="hero-social">
          <a href="https://www.instagram.com/animalets_la_llagosta?igsh=NTc1a2RudDV2dG5l&utm_source=qr" target="_blank" rel="noreferrer" aria-label="Instagram">
          ...
          <a href="https://www.tiktok.com/@animalets_la_llagosta" target="_blank" rel="noreferrer" aria-label="TikTok">
            <svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z" /></svg>
          </a>
          <a href="https://www.facebook.com/animalets.lallagosta.5/" target="_blank" rel="noreferrer" aria-label="Facebook">
